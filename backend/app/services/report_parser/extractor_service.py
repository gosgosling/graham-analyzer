...
_COMPARABLE_FIELDS: tuple[_FieldSpec, ...] = (
    ...
    _FieldSpec("cash_and_equivalents", "Денежные средства", "money_mln", ("general",)),
    ...
    _FieldSpec("operating_cash_flow", "Операц. денежный поток (OCF)", "money_mln", ("general",)),
...
def parse_pdf_to_report(
    ...
    *,
    ...
    payload = FinancialReportCreate(
        ...
        cash_and_equivalents=extracted.cash_and_equivalents,
        debt=extracted.debt,
        ...
        operating_cash_flow=extracted.operating_cash_flow,
