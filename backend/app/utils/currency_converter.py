...
def get_report_values_in_rub(report: FinancialReport) -> Dict[str, Optional[float]]:
    ...
    return {
        ...
        "net_income_reported_rub": convert(report.net_income_reported),
...
def get_report_with_rub_values(report: FinancialReport) -> Dict:
    ...
    return {
        ...
        "net_income_reported": float(report.net_income_reported) if report.net_income_reported else None,
